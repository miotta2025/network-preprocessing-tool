...
const char *argp_program_version = "bootleg nprint 1.2.1";
...
# ARP
arp unsigned short int ar_hrd   2;		  
arp unsigned short int ar_pro   2;		  
arp unsigned char ar_hln        1;		  
arp unsigned char ar_pln        1;		  
arp unsigned short int ar_op    2;			
arp	uint8_t arp_sha[ETH_ALEN]   6;	
arp	uint8_t arp_spa[4]          4;		
arp	uint8_t arp_tha[ETH_ALEN]   6;	
arp	uint8_t arp_tpa[4]          4;		
